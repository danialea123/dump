(function(){
				...
				'<div class="menu-items">' + 
					'{{#elements}}' +
						'<div class="menu-item {{#selected}}selected{{/selected}}">' +
							'{{{label}}} | [<span class="toggle-{{{toggle}}}">{{{toggle}}}</span>]{{#isSlider}} : &lt;{{{sliderLabel}}}&gt;{{/isSlider}}' +
						'</div>' +
					'{{/elements}}' +
				'</div>'+
			'</div>' +
	...
	window.ESX_MENU       = {};
	ESX_MENU.ResourceName = 'esx_menu_toggle';
	ESX_MENU.opened       = {};
	ESX_MENU.focus        = [];
	ESX_MENU.pos          = {};
