...
function TeleportPlayer(floor)
    ESX.SetEntityCoords(cache.ped or PlayerPedId(), floor.x, floor.y, floor.z, true, true, true, false)
...
function TeleportVehicle(floor)
    ...
    ESX.SetEntityCoords(vehicle, floor.x, floor.y, floor.z, true, true, true, false)
