const Targeting = Vue.createApp({
    data() {
        return {
            ...
            SuccessColor: "#00ffff", // This is the color when the target has found the option
    ...
    methods: {
        ...
        FoundTarget(item) {
            ...
            this.HexgonStyleObject.textShadow = "#05f0f0 0px 0 20px";
            this.HexgonStyleObject.webkitTextStroke = "1.5px #09ebeb";
        },
