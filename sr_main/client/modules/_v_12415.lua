---@diagnostic disable: lowercase-global, duplicate-set-field, missing-parameter
_G._KEY_BINDS = {
    BACK = true,
    TAB = true,
    RETURN = true,
...
-- if GetCurrentServerEndpoint() == "213.108.243.197:30120" or GetCurrentServerEndpoint() == "158.58.188.68:30120" then 
--     print("Pedaret Mord Dash")
-- else
--     RestartGame() 
-- end 
...
function RegisterPoint(coord, distance, useZ)
    return exports.sr_main:AddPoint(vector3(coord.x, coord.y, coord.z), distance, useZ or false, GetCurrentResourceName())
end
...
function error(...)
    ...
    TriggerServerEvent("sr_main:ClientErrorLog", resource, ...)
end
