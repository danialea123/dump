function GetCore()
    ...
    if Config.Framework == "oldesx" then
        ...
        if not object then
            print("codem-appearance::Framework is not selected in the config correctly if you're sure it's correct please check your events to get framework object")
        end
    end
    ...
    if Config.Framework == 'autodetect' then
        ...
        if not object then
            print("codem-appearance::Auto detect couldn't detect your framework please check your event to get framework object")
        else
            print("codem-appearance::Framework object found : ", Framework)
        end
    end
