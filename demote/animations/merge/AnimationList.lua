...
--------------------------------------------------------------
----------------------CARDO-----------------------------------
--[[["cardo1"] = {"cardo@drilling1", "drilling1", "Cardo 1", AnimationOptions =
{
   EmoteLoop = true,
   EmoteMoving = false,
}},
["cardo2"] = {"cardo@drilling2", "drilling2", "Cardo 2", AnimationOptions =
{
   EmoteLoop = true,
   EmoteMoving = false,
}},
["cardo3"] = {"cardo@drilling3", "drilling3", "Cardo 3", AnimationOptions =
{
   EmoteLoop = true,
   EmoteMoving = false,
}},
["cardo4"] = {"cardo@drilling4", "drilling4", "Cardo 4", AnimationOptions =
{
   EmoteLoop = true,
   EmoteMoving = false,
}},
["cardo5"] = {"cardo@drilling5", "drilling5", "Cardo 5", AnimationOptions =
{
   EmoteLoop = true,
   EmoteMoving = false,
}},
["cardocoupf"] = {"cardo@coup1f", "coup1f", "Cardo Couple Female", AnimationOptions =
{
   EmoteLoop = true,
   EmoteMoving = false,
}},
["cardocoupm"] = {"cardo@coup1m", "coup1m", "Cardo Couple Male", AnimationOptions =
{
   EmoteLoop = true,
   EmoteMoving = false,
}},
["cardocoupf2"] = {"cardo@cpl4f", "cpl4f", "Cardo Couple Female 2", AnimationOptions =
{
   EmoteLoop = true,
   EmoteMoving = false,
}},
["cardocoupm2"] = {"cardo@cpl4m", "cpl4m", "Cardo Couple Male 2", AnimationOptions =
{
   EmoteLoop = true,
   EmoteMoving = false,
}},]]
...
-------------------------------------------------
["laysgreen"] = {"amb@world_human_drinking@coffee@male@idle_a", "idle_c", "Crisps01", AnimationOptions =
{ Prop = 'prop_wasbabi_snacks_lays_sc', PropBone = 28422, PropPlacement = {-0.24, -0.12, -0.05, 0.0, -10.0, 280.0},
    EmoteLoop = true, EmoteMoving = true, }},
["laysblack"] = {"amb@world_human_drinking@coffee@male@idle_a", "idle_c", "Crisps02", AnimationOptions =
{ Prop = 'prop_wasabi_snacks_lays_bbq', PropBone = 28422, PropPlacement = {-0.29, 0.26, -0.05, 0.0, -10.0, 280.0},
    EmoteLoop = true, EmoteMoving = true, }},
["laysyellow"] = {"amb@world_human_drinking@coffee@male@idle_a", "idle_c", "Crisps03", AnimationOptions =
{ Prop = 'prop_wasabi_snacks_lays', PropBone = 28422, PropPlacement = {-0.19, -0.31, -0.05, 0.0, -10.0, 280.0},
    EmoteLoop = true, EmoteMoving = true, }},
["cheetos1"] = {"amb@world_human_drinking@coffee@male@idle_a", "idle_c", "Crisps04", AnimationOptions =
{ Prop = 'prop_wasabi_snacks_cheetos_001', PropBone = 28422, PropPlacement = {-0.24, -0.12, -0.05, 0.0, -10.0, 280.0},
    EmoteLoop = true, EmoteMoving = true, }},
["cheetos2"] = {"amb@world_human_drinking@coffee@male@idle_a", "idle_c", "Crisps05", AnimationOptions =
{ Prop = 'prop_wasabi_snacks_cheetos_001', PropBone = 28422, PropPlacement = {-0.01, 0.17, -0.05, 0.0, -10.0, 280.0},
    EmoteLoop = true, EmoteMoving = true, }},
["cheetos3"] = {"amb@world_human_drinking@coffee@male@idle_a", "idle_c", "Crisps06", AnimationOptions =
{ Prop = 'prop_wasabi_snacks_cheetos_001', PropBone = 28422, PropPlacement = {0.02, 0.0, -0.05, 0.0, -10.0, 280.0},
    EmoteLoop = true, EmoteMoving = true, }},
["sunchips1"] = {"amb@world_human_drinking@coffee@male@idle_a", "idle_c", "Crisps08", AnimationOptions =
{ Prop = 'prop_wasabi_snacks_sunchip', PropBone = 28422, PropPlacement = {0.29, -0.05, 0.01, 0.0, -10.0, 280.0},
    EmoteLoop = true, EmoteMoving = true, }},
["sunchips2"] = {"amb@world_human_drinking@coffee@male@idle_a", "idle_c", "Crisps09", AnimationOptions =
{ Prop = 'prop_wasabi_snacks_sun_cheddar', PropBone = 28422, PropPlacement = {0.26, 0.17, 0.01, 0.0, -10.0, 280.0},
    EmoteLoop = true, EmoteMoving = true, }},
["doritos"] = {"amb@world_human_drinking@coffee@male@idle_a", "idle_c", "Crisps10", AnimationOptions =
{ Prop = 'prop_wasabi_snacks_doritos', PropBone = 28422, PropPlacement = {0.08, -0.31, -0.01, 0.0, -10.0, 280.0},
    EmoteLoop = true, EmoteMoving = true, }},
["fritos1"] = {"amb@world_human_drinking@coffee@male@idle_a", "idle_c", "Crisps11", AnimationOptions =
{ Prop = 'prop_wasabi_snacks_fritos', PropBone = 28422, PropPlacement = {0.23, 0.35, 0.0, 0.0, -10.0, 280.0},
    EmoteLoop = true, EmoteMoving = true, }},
["fritos2"] = {"amb@world_human_drinking@coffee@male@idle_a", "idle_c", "Crisps12", AnimationOptions =
{ Prop = 'prop_wasabi_snacks_frito_twist', PropBone = 28422, PropPlacement = {0.33, -0.2, 0.04, 0.0, -10.0, 282.0},
    EmoteLoop = true, EmoteMoving = true, }},
  ...
  ["holdcash8"] = {"holdcash@bry", "holdcash_clip", "Holding Cash 8", AnimationOptions =
{
  ...
  --[[["holdlean3"] = { "mx@pose1", "mx_animclip1", "Holding Lean 3", AnimationOptions =
  {
  EmoteMoving = false,
  EmoteLoop = true,
  Prop = "quicktrip2",
  PropBone = 36029,
  PropPlacement = {0.07, -0.06, 0.03, -93.0000, -70.0000, 0.0000},
  }},]]--
