---@diagnostic disable: undefined-field, undefined-global, lowercase-global, param-type-mismatch, missing-parameter
ESX                     = nil
...
function StartDriveTest(type)
	...
	ESX.TriggerServerCallback('xex_pilotschool:payLicense', function(paid)
		if paid == true then
			ESX.Game.SpawnLocalVehicle(Config.VehicleModels[type], Config.Zones.VehicleSpawnPoint.Pos, Config.Zones.VehicleSpawnPoint.Pos.h, function(vehicle)
				local playerPed   = PlayerPedId()
				exports["esx_vehiclecontrol"]:exception()
				Citizen.Wait(500)
				TaskWarpPedIntoVehicle(playerPed, vehicle, -1)
				exports["LegacyFuel"]:SetFuel(vehicle, 100 + 0.0)
				SetVehicleCustomPrimaryColour(vehicle, 255, 255, 255)
				DecorSetFloat(vehicle, "_FUEL_LEVEL", exports["LegacyFuel"]:GetFuel(vehicle))
