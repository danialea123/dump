...
`;}
  ...
  const customThemes = {
    lspd: {
      ...
      name: "Diamond Police Department",
    },
    bcso: {
      color1: "#333333",
      color2: "#57471a",
      ...
      name: "Diamond Sheriff Department",
    },
    sasp: {
      color1: "#423f39",
      color2: "#8f7c3f",
      ...
      color9: "#9c9485",
      color10: "#8F741B",
      image: "img/forces.png",
      name: "Diamond SpecialForces Department",
    },
    sast: {
      color1: "#2c2c2c",
      color2: "#232323",
    ...
    ambulance: {
      ...
      name: "Diamond Medical Department",
    },
    doj: {
      color1: "#553a1e",
      color2: "#5f4321",
      ...
      name: "Diamond Justice Department",
    },
  }
      ...
      activeUnits.forEach((unit) => {
        ...
        if (PoliceJobs[unit.unitType] !== undefined) {
          ...
          activeInfoJob = `<div class="unit-job active-info-job-lspd">LSPD</div>`;
            ...
            activeInfoJob = `<div class="unit-job active-info-job-bcso">BCSD</div>`;
          } else if(unit.unitType == "forces")  { saspCount++;
            activeInfoJob = `<div class="unit-job active-info-job-sasp">LSSF</div>`;
          } else if(unit.unitType == "fbi")  { saspCount++;
            activeInfoJob = `<div class="unit-job active-info-job-sapr">FIB</div>`;
          } else if(unit.unitType == "justice")  { dojCount++;
...
var customImageUrl = 'https://media.diamondrp.ir/map.jpg';
