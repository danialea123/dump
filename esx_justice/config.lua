...
Config.justiceStations = {
	justice = {
		Blip = {
			Station = 'Justice',
			Pos     = { x = -553.37, y = -203.74, z = 38.23},
			Sprite  = 419,
			Display = 4,
			Scale   = 1.1,
			Colour  = 70,
		...
		Cloakrooms = {
			{ x = -559.04, y = -194.08, z = 37.22},
			{ x = 1509.64, y = 767.6572, z = 77.57141},
		},

		Stocks = {
			vector3(-553.37,-203.74,38.23),
		},

		Armories = {
			vector3(-537.6,-175.74,37.22),
			vector3(1513.635, 771.6396, 77.57141),
		},

		Vehicles = {
			{
				Spawner    = vector3(-571.55,-249.02,36.04),  -- asli 
				SpawnPoint = vector3(-579.83,-247.08,35.85), 
				Heading    = 212.49
			},
			{
		...
		AuthorizedItems = {
			...
			{ label = 'Kheshab', name = 'clip', price = 5000 },
			{ label = 'Radio', name = 'radio', price = 5000 },
			{ label = 'Kheshab', name = 'clip', price = 5000 },
			{ label = 'Kheshab Ezafe', name = 'eclip', price = 5000 },
			{ label = 'Drum Magazine', name = 'dclip', price = 5000 },
		},
		...
		VehicleDeleters = {
			vector3(-579.83,-247.08,35.85),
			vector3(1517.077, 795.7187, 78.43665),
			vector3(544.875, 774.4747, 94.64026)
		},

		BossActions = {
			{ x = -549.36, y = -198.51, z = 55.29 },
		},
	},
	--[[justice = {
		Blip = {
			Station = 'justice Station',
