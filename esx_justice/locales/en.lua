Locales['en'] = {
  ['fast_travel'] = 'Dokme ~INPUT_CONTEXT~ Baraye ~y~Enteghal~s~',
  -- Cloakroom
  ...
  -- justice stuff
  ['sbullet_wear'] = 'justice Bullet Proof Vest',
  ['justice_wear'] = 'justice Outfit',
