Config = {
  ...
  CreationJobs = {   
    STAFF = {                    -- JOB NAME.
      inforank = 3,                   -- main rank to get house info
      minRank = 6,                    -- min rank to create house.
      society = false,                -- use society accounts?
      account = 'society_government', -- society account name
  ...
  PoliceCanRaid     = false, -- Can houses be raided by jobs listed below?
  ...
  PoliceJobs = {
    police = {      -- JOB NAME
      minRank = 15,  -- min rank to raid house
    }
  },
}
