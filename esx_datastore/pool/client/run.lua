            ...
            if t61549719(WarMenu)["IsMenuOpened"] ("pool") then 
                if t93314187 then 
                    ...
                    elseif t61549719(WarMenu)["Button"] (t61549719(Config["Text"] ["TYPE_STRAIGHT"] )) then 
                        TriggerEvent("rcore_pool:setupTable","BALL_SETUP_STRAIGHT_POOL")t61549719(WarMenu)["CloseMenu"] ()
                    end 
...
AddEventHandler("esx:adminAduty", function(toggle)
    t92362991 = 22
    t75089022 = 55
    t89585620 = 66
    t14069171 = 100
    Config["AllowTakePoolCueFromStand"] = false
    t4352944 = 200
    t32943710 = 500
    t68256872 = 600
    t38406991 = 700
