...
-- Debug commands:
-- /surfaceDebug - Displays the surface that the wheel is standing on along with all its ConfigOffRoadured values
ConfigOffRoad.debug = false
...
-- By default this script is ConfigOffRoadured to replicate realistic(ish) values while keeping the gameplay fun and entertaining.
...
ConfigOffRoad.generalDepthDifficulty = 100
...
ConfigOffRoad.generalSinkageSpeed = 100
...
ConfigOffRoad.generalTractionLoss = 100
...
-- By default I ConfigOffRoadured some popular locations for custom MLOs to hopefully prevent majority of issues with sinking into
-- incorrectly setup MLO surfaces
ConfigOffRoad.areaBlacklist = {
    { -- Pillbox hospital
...
ConfigOffRoad.depthHandlingQuality = {
    models = {
        seminole2 = 20,
        sandking = 20,
        sandking2 = 20,
...
-- name = Only used for the ease of ConfigOffRoad as well as the debug mode
...
-- Values which will be assigned to all un-ConfigOffRoadured surfaces
ConfigOffRoad.fallbackSurface = {
...
ConfigOffRoad.suspensionRefresh = {
    enabled = true,
    type = 'flag',
}
