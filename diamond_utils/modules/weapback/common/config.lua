...
ConfigWeaponBack.RealWeapons = {
	...
	{name = 'WEAPON_MICROSMG', 			bone = 24816, x = 0.190, y = -0.15, z = 0.01, xRot = 0.0, yRot = -323.5, zRot = 0.0, category = 'assault', 	model = 'w_sb_microsmg'},
	{name = 'WEAPON_SMG', 				bone = 24816, x = 0.190, y = -0.15, z = 0.01, xRot = 0.0, yRot = -323.5, zRot = 0.0, category = 'assault', 	model = 'w_sb_smg'},
	{name = 'WEAPON_MG', 				bone = 24816, x = 0.190, y = -0.15, z = 0.01, xRot = 0.0, yRot = -323.5, zRot = 0.0, category = 'assault', 	model = 'w_mg_mg'},
	{name = 'WEAPON_COMBATMG', 			bone = 24816, x = 0.190, y = -0.15, z = 0.01, xRot = 0.0, yRot = -323.5, zRot = 0.0, category = 'assault', 	model = 'w_mg_combatmg'},
	{name = 'WEAPON_GUSENBERG', 		bone = 24816, x = 0.190, y = -0.15, z = 0.01, xRot = 0.0, yRot = -323.5, zRot = 0.0, category = 'assault', 	model = 'w_sb_gusenberg'},

	{name = 'WEAPON_ASSAULTSMG', 		bone = 24816, x = 0.190, y = -0.15, z = 0.01, xRot = 0.0, yRot = -323.5, zRot = 0.0, category = 'assault', 	model = 'w_sb_assaultsmg'},


	{name = 'WEAPON_ASSAULTRIFLE', 		bone = 24816, x = 0.190, y = -0.15, z = 0.01, xRot = 0.0, yRot = -323.5, zRot = 0.0, category = 'assault', 	model = 'w_ar_assaultrifle'}, 
	{name = 'WEAPON_ASSAULTRIFLE_MK2', 		bone = 24816, x = 0.190, y = -0.15, z = 0.01, xRot = 0.0, yRot = -323.5, zRot = 0.0, category = 'assault', 	model = 'w_ar_assaultrifle'}, 
	
	{name = 'WEAPON_CARBINERIFLE', 		bone = 24816, x = 0.190, y = -0.15, z = 0.01, xRot = 0.0, yRot = -323.5, zRot = 0.0, category = 'assault', 	model = 'w_ar_carbinerifle'},
	{name = 'WEAPON_CARBINERIFLE_MK2', 		bone = 24816, x = 0.190, y = -0.15, z = 0.01, xRot = 0.0, yRot = -323.5, zRot = 0.0, category = 'assault', 	model = 'w_ar_carbinerifle'},

	{name = 'WEAPON_ADVANCEDRIFLE', 	bone = 24816, x = 0.190, y = -0.15, z = 0.01, xRot = 0.0, yRot = -323.5, zRot = 0.0, category = 'assault', 	model = 'w_ar_advancedrifle'},

	{name = 'WEAPON_SPECIALCARBINE', 	bone = 24816, x = 0.190, y = -0.15, z = 0.01, xRot = 0.0, yRot = -323.5, zRot = 0.0, category = 'assault', 	model = 'w_ar_specialcarbine'},
	{name = 'WEAPON_SPECIALCARBINE_MK2', 	bone = 24816, x = 0.190, y = -0.15, z = 0.01, xRot = 0.0, yRot = -323.5, zRot = 0.0, category = 'assault', 	model = 'w_ar_specialcarbine'},

	{name = 'WEAPON_BULLPUPRIFLE', 		bone = 24816, x = 0.190, y = -0.15, z = 0.01, xRot = 0.0, yRot = -323.5, zRot = 0.0, category = 'assault', 	model = 'w_ar_bullpuprifle'},
	{name = 'WEAPON_BULLPUPRIFLE_MK2', 		bone = 24816, x = 0.190, y = -0.15, z = 0.01, xRot = 0.0, yRot = -323.5, zRot = 0.0, category = 'assault', 	model = 'w_ar_bullpuprifle'},


	{name = 'WEAPON_PUMPSHOTGUN', 		bone = 24816, x = 0.190, y = -0.15, z = 0.01, xRot = 0.0, yRot = -323.5, zRot = 0.0, category = 'assault', 	model = 'w_sg_pumpshotgun'},

	{name = 'WEAPON_BULLPUPSHOTGUN', 	bone = 24816, x = 0.190, y = -0.15, z = 0.01, xRot = 0.0, yRot = -323.5, zRot = 0.0, category = 'assault', 	model = 'w_sg_bullpupshotgun'},
	{name = 'WEAPON_ASSAULTSHOTGUN', 	bone = 24816, x = 0.190, y = -0.15, z = 0.01, xRot = 0.0, yRot = -323.5, zRot = 0.0, category = 'assault', 	model = 'w_sg_assaultshotgun'},
	{name = 'WEAPON_MUSKET', 			bone = 24816, x = 0.190, y = -0.15, z = 0.01, xRot = 0.0, yRot = -323.5, zRot = 0.0, category = 'assault', 	model = 'w_ar_musket'},
	{name = 'WEAPON_HEAVYSHOTGUN', 		bone = 24816, x = 0.190, y = -0.15, z = 0.01, xRot = 0.0, yRot = -323.5, zRot = 0.0, category = 'assault', 	model = 'w_sg_heavyshotgun'},
...
ConfigWeaponBack.nameModels = {}

for k, v in pairs(ConfigWeaponBack.RealWeapons) do
	ConfigWeaponBack.nameModels[v.name] = v.model 
end

ConfigWeaponBack.objectModels = {}

for k, v in pairs(ConfigWeaponBack.RealWeapons) do
	ConfigWeaponBack.objectModels[GetHashKey(v.model)] = v.model 
end

exports("GetWeapons", function()
	return ConfigWeaponBack.objectModels
end)

ConfigWeaponBack.Bags = {
	[`mp_m_freemode_01`] = {
		[40] = true,
		[41] = true,
		[44] = true,
