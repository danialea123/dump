...
Config.Zones = {
	...
	Garages = {
		...
		{ -- Jazire
			GaragePos  = vector3(4812.02,-4274.89,1.9),
			SpawnPoint = vector4(4821.27,-4258.55,-0.07,83.26),
			StorePos   = vector3(4821.27,-4258.55,-0.07),
			StoreTP    = vector4(4812.02,-4274.89,2.9, 0.0)
		},
	},
	...
	BoatShops = {
		{ -- Shank St, nearby campaign boat garage
			...
			Inside = vector4(-798.5, -1503.1, -0.4, 119.7)
		}
	}
...
Config.Vehicles = {
	{model = 'seashark', label = 'Seashark (Random Color)', price = 300000},
	{model = 'seashark3', label = 'Seashark (Dark Blue)', price = 500000},
	{model = 'suntrap', label = 'Suntrap', price = 1000000},
	{model = 'jetmax', label = 'Jetmax', price = 3800000},
	{model = 'tropic2', label = 'Tropic', price = 1500000},
	{model = 'speeder', label = 'Speeder', price = 5000000},
	{model = 'squalo', label = 'Squalo (Random Color)', price = 1200000},
	{model = 'Marquis', label = 'luxury', price = 25000000}
}