Config = {
    ...
    Items = {
        ["drinks"] = {
            {label = "Coca Cola", item = "cocacola", price = 500},
            {label = "Fanta", item = "fanta", price = 500},
            {label = "Sprite", item = "sprite", price = 500},
            {label = "Ab", item = "water", price = 350},
            {label = "Pepsi", item = "pepsi", price = 350},
        },
        ["snacks"] = {
            {label = "Snack", item = "cheesebows", price = 500},
            {label = "Chips", item = "chips", price = 400},
            {label = "Shokolat", item = "marabou", price = 300},
            {label = "Snickers", item = "snickers", price = 300},
            {label = "Mars", item = "mars", price = 300},
            {label = "Croissant", item = "crossan", price = 300},
        },
        ["readymeal"] = {
            {label = "Pitza", item = "pizza", price = 1000},
            {label = "Burger", item = "burger", price = 750},
            {label = "Noon", item = "bread", price = 400},
            {label = "Sandwitch", item = "macka", price = 600},
        },
        ["diverse"] = {
            {label = "Cigar", item = "cigarett", price = 100},
            {label = "Fandak", item = "lighter", price = 2000},
            {label = "Sharab", item = "wine", price = 6000},
            {label = "Whiskey", item = "whiskey", price = 7000},
            {label = "Vodka", item = "vodkaenergy", price = 5500},
            {label = "Gooshi", item = "phone", price = 9000},
            {label = "Radio", item = "radio", price = 100000},
            {label = "Bandage", item = "cbandage", price = 1500},
        },
    },
}