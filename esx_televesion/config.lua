...
Config.Framework = "esx"  -- types (standalone, qbcore, esx, custom)
...
Config.TelevisionPermissions = true -- enable this if you want use permission system for some locations, you need define locations in Config.TelevisionPermissionsLocations
...
Config.EnableImagesForTv = true -- enable putting images to tv (png, gif, jpg)
...
Config.TelevisionPermissionsLocations = { -- You need enable Config.TelevisionPermissions for use this
	{
		...
		permissionace = "rtxtv.cinema", --put here your ace permission -- example in server.cfg add_ace identifier.steam:11000013cc73739 "rtxtv.cinema" allow
	},
}
