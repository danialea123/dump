Locales['en'] = {
  ...
  ['bullet'] = 'tavasot golole koshte shode.',
  ['knifes'] = 'tavasot chagho koshte shod.',
  ['bitten'] = 'tavasaot heyvan gaz gerefte shode.',
  ['brokenlegs'] = 'paha shekast.',
  ['explosive'] = 'sokhtgi darage 4.',
  ['buy_items'] = 'Buy Items',
  ['buy_stock_menu'] = 'Buy Stock Menu',
  ['gas'] = 'Khafe shode.',
  ['fireextinguisher'] = 'tavasot gaz dar atash.',
  ['fire'] = 'Atash sozi.',
  ['caraccident'] = 'Tasadof karde.',
  ['drown'] = 'ghargh shode.',
  ['unknown'] = 'Namoshakhas.',
