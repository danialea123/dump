                ...
                Enable = function(state)
                    ...
                    if (state) then
                        if (handle == 0) then
                            ...
                            local privacyGlass = ESX.Game.SpawnLocalObject(DoomsdayFacility.PrivacyGlass.controlModelHash, vector3(DoomsdayFacility.PrivacyGlass.Bedroom.Control.position.x, DoomsdayFacility.PrivacyGlass.Bedroom.Control.position.y, DoomsdayFacility.PrivacyGlass.Bedroom.Control.position.z))
                ...
                Enable = function(state)
                    ...
                    if (state) then
                        if (handle == 0) then
                            ...
                            local privacyGlass = ESX.Game.SpawnLocalObject(DoomsdayFacility.PrivacyGlass.controlModelHash, vector3(DoomsdayFacility.PrivacyGlass.Lounge.Control.position.x, DoomsdayFacility.PrivacyGlass.Lounge.Control.position.y, DoomsdayFacility.PrivacyGlass.Lounge.Control.position.z))
