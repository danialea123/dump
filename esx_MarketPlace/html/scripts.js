					...
					<div class="col-md-3">
						<div class="card item_card d-flex flex-column">
							<div class="card-body text-center flex-grow-1 d-flex flex-column justify-content-between pb-1 align-items-center">
								...
								<img src="http://5.42.217.109/imgs/${img}.png" class="image">
					...
					<div class="col-md-3">
						<div class="card item_card d-flex flex-column">
							<div class="card-body text-center flex-grow-1 d-flex flex-column justify-content-between pb-1 align-items-center">
								...
								<img src="http://5.42.217.109/imgs/${itemsAds[i].item_id}.png" class="image">
								<div class="item_card-spacer" style="margin-bottom: -50;">
					...
					<div class="col-md-3">
						<div class="card item_card d-flex flex-column">
							<div class="card-body text-center flex-grow-1 d-flex flex-column justify-content-between pb-1 align-items-center">
								...
								<img src="http://5.42.217.109/imgs/${blackmarketAds[i].item_id}.png" class="image">
								<div class="item_card-spacer" style="margin-bottom: -50;">
...
$(document).on('click', "#confirmPlaceAd", function() {
	...
	if (price > 0 && veh > 0) {
		$.post('https://esx_MarketPlace/action', JSON.stringify({
			action: "placeAd",
