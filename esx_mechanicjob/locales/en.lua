Locales['en'] = {
  	...
  	['work_wear']                 = 'Lebas Kar',
	['civ_wear']                  = 'Lebas Shahrvandi',
	['open_boss_actions']         = 'Dokme ~INPUT_CONTEXT~ Baraye Baz Shodan Boss Menu',
	['toggle_job']				  = '~INPUT_CONTEXT~ Baraye [~g~ON~s~/~r~OFF~s~] ~y~Duty~s~',
	['on_duty']					  = 'Shoma ~g~ON~s~ Duty Shodid!',
	['off_duty']				  = 'Shoma ~r~OFF~s~ Duty Shodid!',
	['open_garage']               = 'Dokme ~INPUT_CONTEXT~ Baraye Baz Shodan Garage Mashin',
	['spawn_points_blocked']	  = 'Makan Haye Spawn Mashin ~r~Por~s~ Ast!',
	['clothe_menu']				  = 'Komod Lebas',
  	['deposit_stock']             = 'Deposit Stock',
  	['withdraw_stock']            = 'Withdraw Stock',
  	['boss_actions']              = 'boss Actions',
  	['service_vehicle']           = 'service Vehicle',
  	['flat_bed']                  = 'flatbed',
  	['tow_truck']                 = 'tow Truck 2',
  	['towtruck']                  = 'tow Truck',
