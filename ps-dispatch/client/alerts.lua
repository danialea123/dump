...
local function CustomAlert(data)
    ...
    local dispatchData = {
        ...
        alert = {
            ...
            scale = data.scale or 0.7, -- Scale of the blip
        ...
        jobs = { "police","sheriff","fbi","justice","forces"},
    }
...
local function OfficerDown()
    ...
    local dispatchData = {
        ...
        alertTime = 10,
        jobs = { "police","sheriff","fbi","justice","forces", "ambulance", "medic"}
    }
...
RegisterNetEvent('ps-dispatch:client:sendEmergencyMsg', function(data, type, anonymous)
    local jobs = { ['911'] = {"police","sheriff","fbi","justice","forces", } }
